  ...
  <body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
   ...
   <section>
      ...
      <main>
        <!-- 1 -->
        <div
          class="gallery-container-contined-container container-testim-motivate"
        >
          <div class="gallery-container">
            ...
            <div class="button-gallery-contained">
    ...
    <div class="Contact">
        <div class="Contact-main10 testi-contact-main">
            <div class="Contact-main-inside inside-bext-container">
                <div class="Contact-right-section left-testiii aos-init aos-animate" id="right-form" data-aos="fade-right" data-aos-offset="200" data-aos-duration="600">
                    <form id="contactus">
                        <div class="form-container">
                            ...
                            <div class="form-paraa-flex">
                                <p>
                                    Simply complete the form and one of our team will get in touch to help you get the smile you deserve.
                                </p>
                            </div>
                            <div class="flex-item">
                                <div class="contact-right-label lable-setting" id="contact-right-label">
                                    <label for="name">Name</label>
                                </div>
                                <div id="contact-right-input" class="contact-right-input goooood contact-right-input-done done-flex set-indirect">
                                    <input type="text" id="name" name="user_name" placeholder="Your Name" class="input-image-set22" value="" />
                                </div>
                            </div>
                            <div class="flex-item-gallery-contained">
                                <div class="flex-item">
                                    <div  class="contact-right-label lable-setting email-labelll lll-label set-flev" id="contact-right-label">
                                        <label for="phone">Phone No.</label>
                                    </div>
                                    <div  id="contact-right-input" class="contact-right-input bbbtttt goooood content-flex done-flex">
                                        <input type="text" id="phone" name="phone" placeholder="Phone" class="input-image-set23" value="" />
                                    </div>
                                </div>
                                <div class="flex-item">
                                    <div class="contact-right-label lable-setting email-labelll label-set-max" id="contact-right-label">
                                        <label for="email">Email Address</label>
                                    </div>
                                    <div  id="contact-right-input" class="contact-right-input bbbtttt goooood content-flex done-flex">
                                        <input type="text" id="email" name="email" placeholder="Enter your email address" class="input-image-set24" value="" />
                                    </div>
                                </div>
                            </div>
                            <div class="flex-item">
                                <div class="contact-right-label ok-labellll hmm-label" id="contact-right-label">
                                    <label for="practice">
                                        Which Practice would you like to be treated at</label>
                                </div>
                                <div class="custom-select2" id="custom-select2">
                            ...
                            <div class="flex-item">
                                <div class="contact-right-label ok-labellll hmm-label" id="contact-right-label">
                                    <label for="message">Please enter any additional comments</label>
                                </div>
                                <textarea id="message" name="message" placeholder="Please enter any additional comments"></textarea>
                            </div>
                        </div>
                        <div class="form-container">
                            ...
                            <div class="form-button-gallery">
                                <button type="submit" id="submitContactForm">Submit Form</button>
                            </div>
                        </div>
                    </form>
                </div>
